...
namespace Utility.AutoMapper
{
    public class MappingProfile : Profile
    {
        public MappingProfile()
        {
            ...
            .ForMember(destination => destination.DailyRateStr, option => option.MapFrom(source => source.DailyRate.ToCurrency()))
            ...
            .ForMember(destination => destination.NetPay, option => option.MapFrom(source => source.Payrolls.GetCurrentPayroll().NetPay))
            .ForMember(destination => destination.Vessel, option => option.MapFrom(source => source.Vessel))

$(document).ready(function () {
  if ($("#table").length > 0) {
    ...
    // );
    $(".custom-filter").prepend(
      '<select class="mx-2 mb-2" title="Select vessel"><option>--select period--</option><option>Period 1</option><option>Period 2</option><option>Period 3</option></select>'
    );
    $(".custom-filter").prepend(
      '<select class="mx-2 mb-2" title="Select vessel"><option>Vessel 1</option><option>Vessel 2</option><option>Vessel 3</option></select>'
    );
    $(".custom-filter").append(
      '<a class="mx-2 mb-2 text-primary">View All</a>'
    );
